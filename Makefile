...
pkgdatadir = $(datadir)/ergo-telescope
pkgincludedir = $(includedir)/ergo-telescope
pkglibdir = $(libdir)/ergo-telescope
pkglibexecdir = $(libexecdir)/ergo-telescope
...
PACKAGE_STRING = ergo-telescope 1.4
PACKAGE_TARNAME = ergo-telescope
PACKAGE_URL = 
PACKAGE_VERSION = 1.4
PATH_SEPARATOR = :
SET_MAKE = 
...
install_sh = ${SHELL} /home/matt/Projects/Code/ERGO/ergo-telescope/install-sh
